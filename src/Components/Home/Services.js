...
const Services = () => {
  ...
  return (
    <>
      <div className="bg-sky-blue-100 p-[6%] !pb-[4%]">
        ...
        <div className="box grid  lg:grid-cols-3  text-center gap-10 lg:p-10">
          {serviceData?.data?.data?.[0]?.details?.map((item) => (
            <div className="box-item group  bg-white relative px-4 py-10 flex flex-col items-center gap-3 text-black shadow-md hover:shadow-2xl  hover:-translate-y-4    transition-all duration-300">
              <div>
