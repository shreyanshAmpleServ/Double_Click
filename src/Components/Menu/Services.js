    ...
    <div className="bg-sky-blue-100 p-[6%] !pb-[4%]">
      ...
      ></div>
          <div className="absolute inset-0 bg-primary opacity-60 z-10 rounded-md"></div>
              ...
              <div ><TbTruckDelivery className="!text-5xl text-white transform scale-x-[-1]" /></div>
      ...
      ></div>
          <div className="absolute inset-0   bg-primary opacity-60 z-10 rounded-md"></div>
              ...
              <div ><ImAirplane className="!text-5xl text-white transform scale-x-[-1]" /></div>
      ...
      ></div>
          <div className="absolute inset-0  bg-primary opacity-60 z-10 rounded-md"></div>
              <div  className="absolute z-30 top-[65%] mx-auto w-full flex flex-col gap-3 items-center  group-hover:-translate-y-4    transition-all duration-300 ">
              <div ><FaShip className="!text-5xl text-white transform scale-x-[-1]" /></div>
